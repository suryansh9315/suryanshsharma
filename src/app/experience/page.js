...
const Experience = () => {
  return (
    <div className="">
      ...
      >
        <div className="text-[36px] xl:text-[44px] pb-10 md:py-10 font-bold text-[#1a1a1a] font-poppins leading-[40px] xl:leading-[50px]">
          Experience
        </div>
          ...
          {ExperienceList.map((experience, id) => (
            <div key={id} className="flex gap-2 md:gap-5 flex-col xl:flex-row">
              ...
              <div className="w-full xl:w-[50%] flex flex-col px-3 xs:px-5 py-3 xs:py-5">
                <div className="text-[24px] xs:text-[26px] font-poppins text-[#1a1a1a]">
                  {experience.company}
                </div>
                ...
                <ul className="flex flex-col gap-1 mt-3 list-disc">
                  {experience.summary.map((list, id) => (
                    <li
                      className="text-[12px] xs:text-[14px] font-poppins text-[#666]"
                      key={id}
                    >
                      {list}
                    </li>
